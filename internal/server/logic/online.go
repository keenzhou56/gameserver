...
// SetUserOnline ...
func (l *Logic) SetUserOnline(c context.Context, online uint64) (err error) {
	err = l.dao.SetUserOnline(c, online)
	return
}

// GetUserOnline ...
func (l *Logic) GetUserOnline(c context.Context) (online uint64, err error) {
	online, err = l.dao.GetUserOnline(c)
	return
}
